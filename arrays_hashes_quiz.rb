...
# puts lines[-1]
# puts lines.dig(4)
# lines.each {|x| puts x if x.include? "Pr"}
# puts lines.fetch(4)
...
# my_hash.merge!(hash)
# p my_hash
# Not the easiest way to do as I have now learnt but is A way!
...
# ((users["Erik"][:favourite_numbers]).push(7)).sort!
# p users["Erik"][:favourite_numbers]
...
# users["Catriona"] =
# {
#   :twitter => "catrionameriel",
#   :favourite_numbers => [10, 18, 30],
#   :home_town => "Glasgow",
#   :pets => {"scout" => :cat}
#   }
